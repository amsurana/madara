  ...
  for (int i = 1; i < argc; ++i)
  {
    ...
    else if (arg1 == "-h" || arg1 == "--help")
    {
      madara_logger_ptr_log(logger::global_logger.get(), logger::LOG_ALWAYS,
          ...
          "  [-lz4l|--lz4-load]       use lz4 compression to load from file\n"
          "  [-lz4s|--lz4-save]       use lz4 compression to save to file\n"
          ...
          "  [-ssll|--ssl-load pass]  decrypt with pass during load\n"
          "  [-ssls|--ssl-save pass]  encrypt with pass during save\n"
